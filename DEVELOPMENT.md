...
```bash
git remote add encore encore://anuradha-dutta-astrologer-healer-obd2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/anuradha-dutta-astrologer-healer-obd2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/anuradha-dutta-astrologer-healer-obd2/settings/integrations/github)
